...
<html>
    ...
    <body>
        ...
        <div class="LoginWrapper">
            <form action="vendor/signup.php" method="post" class="LoginForm">
                <input type="text" placeholder="login" name="login" class="LoginInput">
                <input type="email" placeholder="email" name="email" class="LoginInput">
                <input type="password" placeholder="password" name="password" class="LoginInput">
                <input type="password" placeholder="passwordconfirm" name="passwordconfirm" class="LoginInput">
                <button class="LoginBtn">Заргистрироваться</button>
                <a href="login.php" class="LoginA">Авторизация</a>
                <?php
                session_start();
                ?>
                <?php
